...
export default function ModelDetail() {
    ...
    const fetchProductDetails = async (productId) => {
        try {
            const response = await axiosClient.get(`/models/${productId}`);
            ...
            <div className="product-detail">
                <div className="container">
                    <div className="product-detail__wrapper">
                        <ProductImageGallery images={productDetails.modelUrl} />
                        <div className="product-detail__info">
                            <h2 className="product-detail__category">
                                {productDetails.category?.title || "Danh mục"}
                            </h2>
                            <h1 className="product-detail__title">{productDetails.modelName}</h1>
                            ...
                            <div className="product-detail__total-price">
                                Ước tính: {totalPrice.toLocaleString()} đ
                            </div>
